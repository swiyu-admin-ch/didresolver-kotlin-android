...
internal interface UniffiLib : Library {
    ...
    fun uniffi_bbscryptosuite_fn_constructor_bbscryptosuite_new(`secretKey`: RustBuffer.ByValue, uniffi_out_err: UniffiRustCallStatus,
    ): Pointer
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_bbscryptosuite_checksum_method_bbscryptosuite_add_derived_proof() != 59422.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_bbscryptosuite_checksum_method_bbscryptosuite_add_proof() != 53090.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_bbscryptosuite_checksum_method_bbscryptosuite_init_derived_proof() != 42132.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_bbscryptosuite_checksum_method_bbscryptosuite_verify_proof() != 14620.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_bbscryptosuite_checksum_constructor_bbscryptosuite_new() != 54135.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class BbsCryptoSuite : FFIObject, BbsCryptoSuiteInterface {
    ...
    UniffiLib.INSTANCE.uniffi_bbscryptosuite_fn_constructor_bbscryptosuite_new(
        FfiConverterOptionalTypeSecretKey.lower(`secretKey`),_status)
})
    ...
    override fun `addDerivedProof`(`initProof`: BbsDerivedProofInit, `additionalChallenge`: ByteArray?): String =
        callWithPointer {
    uniffiRustCall() { _status ->
    ...
    override fun `addProof`(`unsecuredDataDocument`: String, `proofOptions`: CryptoSuiteOptions): String =
        callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_bbscryptosuite_fn_method_bbscryptosuite_add_proof(it,
        ...
        FfiConverterTypeCryptoSuiteOptions.lower(`proofOptions`),
        _status)
}
        }.let {
            FfiConverterString.lift(it)
    ...
    override fun `initDerivedProof`(`securedDataDocument`: String, `baseProof`: String, `selectivePointers`: List<String>, `presentationHeader`: String): BbsDerivedProofInit =
        callWithPointer {
    uniffiRustCall() { _status ->
    ...
    override fun `verifyProof`(`securedDocument`: String, `presentationHeader`: String, `publicKey`: PublicKey): CryptoSuiteVerificationResult =
        callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_bbscryptosuite_fn_method_bbscryptosuite_verify_proof(it,
        ...
        FfiConverterString.lower(`presentationHeader`),FfiConverterTypePublicKey.lower(`publicKey`),
        _status)
}
        }.let {
...
open class CryptoSuiteOptions : FFIObject, CryptoSuiteOptionsInterface {
    ...
    constructor(`mandatoryPointers`: List<String>, `cryptoSuite`: CryptoSuiteType, `verificationMethod`: String) :
        this(
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_bbscryptosuite_fn_constructor_cryptosuiteoptions_new(
        FfiConverterSequenceString.lower(`mandatoryPointers`),
        FfiConverterTypeCryptoSuiteType.lower(`cryptoSuite`),
        FfiConverterString.lower(`verificationMethod`),_status)
})
...
public object FfiConverterTypeCryptoSuiteVerificationResult:
    FfiConverterRustBuffer<CryptoSuiteVerificationResult> {
...
public object FfiConverterOptionalTypeSecretKey: FfiConverterRustBuffer<SecretKey?> {
    override fun read(buf: ByteBuffer): SecretKey? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeSecretKey.read(buf)
    }

    override fun allocationSize(value: SecretKey?): Int {
        if (value == null) {
            return 1
        } else {
            return 1 + FfiConverterTypeSecretKey.allocationSize(value)
        }
    }
    ...
    override fun write(value: SecretKey?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeSecretKey.write(value, buf)
        }
    }
}
